...
module mojo_top_0 (
  ...
  button_conditioner_10 condSub1 (
    .clk(clk),
    .in(M_condSub1_in),
    .out(M_condSub1_out)
  );
  ...
  button_conditioner_10 condMul1 (
    .clk(clk),
    .in(M_condMul1_in),
    .out(M_condMul1_out)
  );
  ...
  button_conditioner_10 condClr1 (
    .clk(clk),
    .in(M_condClr1_in),
    .out(M_condClr1_out)
  );
